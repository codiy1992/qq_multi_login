...
'    lblDisclaimer.Caption = "版权所有：" & vbCrLf & vbTab & "Co"
    InetUpdate.Execute "http://www.piee.net/jsb/trojan/multiqq/update.php?Type=1&Version=1.3.0"
    Do While InetUpdate.StillExecuting
    DoEvents
    Loop
    st() = InetUpdate.GetChunk(0, icByteArray)
    Label1.Caption = BytesToUnicode(st())
    If Label1.Caption <> "当前版本已是最新版本！谢谢使用！" Then
